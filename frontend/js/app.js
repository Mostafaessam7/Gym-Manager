...
const NAV_ITEMS = [
  ...
  { path: '/leads', label: 'CRM', icon: '🎯', permission: 'crm:view' },
  ...
  { path: '/fitness', label: 'Nutrition & Workouts', icon: '🥗', permission: 'nutrition:view' },
  { path: '/staff', label: 'Staff', icon: '🗓️', permission: 'staff:view' },
  ...
  { path: '/gift-cards', label: 'Gift Cards', icon: '🎁', permission: 'gift-cards:view' },
